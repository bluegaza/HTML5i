...
#End Region
  ...
  Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If Request("n") <> "" Then
      ...
      Title = Photo.Title(Request("l"))
      Description = Photo.Description(Request("l"))
      ...
      End If
      Subject = PhotoAlbum.Load(Photo.Album).Title(Request("l"))
    Else
      Src = Server.MapPath(Request("src"))
    End If
  ...
  Sub SendFile(ByRef File As String, ByVal Title As String, ByVal Description As String, ByVal Subject As String)
    ...
    If Album Is Nothing OrElse Not Album.StartsWith("users/") OrElse Setting.Aspect.ImageRendering.DoNotApplyTheImagesToneToUsers = False Then
      ...
      Dim Tone As String = Request("tone")
      ...
      If Setup.RenderingEngine.ImageCopyright And Size >= 150 Then
        ...
        Try
          If Setup.RenderingEngine.FontCopyright IsNot Nothing Then
            ...
            End If
            Alpha = Setup.RenderingEngine.FontCopyright.Alpha
          End If
        Catch ex As Exception
        ...
        g.DrawString("© " & Extension.DomainName, Font, Brush, Position)
    ...
    Else
      If Image.Palette.Entries.Length Then
